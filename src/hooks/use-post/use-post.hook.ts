...
import { FetchPostParams, HiddenPostParams } from '../../models';
...
export const usePost = () => {
  ...
  const isLoadingHiddenPost = useObserver(() => CorePostStore.isHiddenPostSelector());
  ...
  const hiddenPost = useCallback((data: HiddenPostParams) => {
    CorePostStore.hiddenPostAction(data);
  }, []);
