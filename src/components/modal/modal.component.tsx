              ...
              {type === 'confirm' && (
                <div className="flex flex-row-reverse">
                  <button
                    onClick={() => confirm()}
                    type="submit"
                    className="rounded-md  flex justify-center items-center gap-2  h-10 text-sm px-4 py-2 bg-primary-4 dark:bg-primary-5 text-white dark:text-gray-100 hover:bg-primary-5 dark:hover:bg-primary-6 break-words transition duration-200 ml-5"
                    tabIndex={-1}
                  >
