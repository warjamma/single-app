...
export const TopNav: React.FC<ITopNavProps> = () => {
  ...
  return (
    <header className="fixed top-0 z-40 w-screen h-16 bg-white dark:bg-zinc-900 py-2 border-b border-gray-300 shadow-md">
        ...
        <div className="flex justify-between items-center lg:space-x-8 h-12">
          <div className="flex items-center h-full">
            <a href="/" className="hidden lg:block w-max h-full lg:mr-4">
              <LazyLoadImage className="h-full w-auto" src="https://about.cab.vn/cab.svg" alt="CAB" />
            </a>
            <form method="get">
          ...
          <div className="flex justify-end items-center gap-2 h-full w-4/12 md:w-6/12 min-[320px]:w-full">
            <Button
              className="rounded-md  flex justify-center items-center gap-2  h-10 text-sm px-4 py-2 text-primary-6 dark:text-primary-3 hover:bg-primary-6/20 dark:hover:bg-primary-6/20 break-words transition duration-200 "
              type="link"
            ...
            {isLogin && (
              <Button
                className={`rounded-md relative flex justify-center items-center gap-2  h-10 text-sm px-4 py-2 text-primary-6 dark:text-primary-3 ${
                  isShowNotifyPopup && 'bg-primary-6/20'
                } hover:bg-primary-6/20 dark:hover:bg-primary-6/20 break-words transition duration-200`}
                type="button"
            ...
            <div className="relative">
              <Button
                className="rounded-md  flex justify-center items-center gap-2  h-10 text-sm px-4 py-2 bg-primary-6/20 dark:bg-primary-6/20 text-primary-6 dark:text-primary-3 break-words transition duration-200 "
              ...
              {isShowExtendMenu && (
                ...
                >
                  <ul className="text-sm">
                    {isLogin && (
                      <li>
                        <a
                          href="u/cab"
                          className="block rounded-md px-4 py-2 hover:bg-gray-1 dark:hover:bg-gray-10"
                          target="_blank"
                          rel="noreferrer"
                        >
                          Trang cá nhân
                  ...
                  <button
                    type="button"
                    className="rounded-md flex justify-center items-center gap-2 h-10 text-sm px-4 py-2 text-primary-6 dark:text-primary-3 hover:bg-primary-6/20 dark:hover:bg-primary-6/20 break-words transition duration-200 w-full"
                    onClick={() => toggleTheme()}
                  >
                    <div className="line-clamp-1">
