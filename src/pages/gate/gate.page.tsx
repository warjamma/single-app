...
const PUBLIC_PRIVATE_TEST_CODE = process.env.PUBLIC_PRIVATE_TEST_CODE;
...
export const GatePage: React.FC<IGatePageProps> = () => {
  ...
  return (
    <div className="toto-gate w-screen min-h-screen bg-center bg-cover flex justify-center items-center p-2" style={{ backgroundImage: 'url("https://picsum.photos/1600/900")' }}>
