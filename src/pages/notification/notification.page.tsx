...
export const NotificationPage: React.FC<INotificationPageProps> = (props) => {
  ...
  return (
    <div className={`notification-page flex justify-center dark:bg-gray-800 py-6 ${isDropdown ? '' : 'pt-20'}`}>
      <Helmet>
        <title>Notification Page</title>
        <meta name="home" content="Notification Page" />
      </Helmet>
      <div className={`w-[600px] bg-white rounded-md dark:bg-gray-800 ${isDropdown ? '' : 'shadow shadow-slate-250'}`}>
        <InfiniteScroll
