...
const iconTrendingUp = <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="tabler-icon tabler-icon-trending-up ">
  <path d="M3 17l6 -6l4 4l8 -8" />
  <path d="M14 7l7 0l0 7" />
</svg>

const iconAwardFilled = <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="tabler-icon tabler-icon-award-filled ">
            ...
            <div className="space-y-4">
              <section>
                <div className="rounded-xl flex transition duration-200 bg-gray-100 dark:bg-gray-900 flex-col">
                  ...
                  <div className="splide splide--slide splide--ltr splide--draggable is-active is-overflow is-initialized" aria-label="My Favorite Images" id="splide02" role="region" aria-roledescription="carousel">
                    <div className="splide__track splide__track--slide splide__track--ltr splide__track--draggable" id="splide02-track" aria-live="polite" aria-atomic="true" style={{ paddingLeft: '0px', paddingRight: '0px' }}>
                      <ul className="splide__list" id="splide02-list" role="presentation" style={{ transform: 'translateX(0px)' }}>
                        <li className="splide__slide is-active is-visible" id="splide02-slide01" role="group" aria-roledescription="slide" aria-label="1 of 3" style={{ width: 'calc(100%)' }}><img src="https://picsum.photos/id/100/2500/1656.jpg" alt="Slide" /> </li>
                ...
                <div className="rounded-xl flex transition duration-200 bg-gray-100 dark:bg-gray-900 flex-col">
                  ...
                  <div className="px-4 pb-4">
                    <div role="navigation" className="w-full">
                      <ul className="rounded-full bg-gray-100 dark:bg-gray-800 backdrop-blur flex w-max mb-4 overflow-x-auto scrollbar-hide" role="tablist" />
                    </div>
                    <ul className="space-y-2">
                      <li>
                        {
                          asideRightContentMock?.leaderboard && asideRightContentMock?.leaderboard.map((member) => {
                            const { id, name, avatar, link } = member;
                            return <a key={id} href={link} target="_self" className="rounded-md  flex justify-start items-center gap-2  h-8 text-xs px-2 py-1 text-brand-500 dark:text-brand-200 hover:bg-brand-500/20 dark:hover:bg-brand-500/20 break-words transition duration-200 " role="button" tabIndex={-1}>
                              <div className="line-clamp-1">
                                <div className="flex items-center gap-2"><img className="rounded-full w-6 h-6" src={avatar} alt="" /> <span className="text-xs font-semibold">{name}</span></div>
                              </div>
                            </a>
                          })
                        }
                ...
                <div className="rounded-xl flex transition duration-200 bg-gray-100 dark:bg-gray-900 flex-col">
                  ...
                  <div className="px-4 pb-4">
                    <div className="flex flex-wrap justify-center items-center">
                      {
                        asideRightContentMock?.hashtags && asideRightContentMock?.hashtags.map((hashtag, index) => {
                          return <a
                            key={index}
